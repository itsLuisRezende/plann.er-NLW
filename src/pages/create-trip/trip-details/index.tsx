import { Calendar, CircleCheck, CircleDashed, Link2, MapPin, Plus, Settings2, UserCog, X, Tag } from "lucide-react";
                        ...
                        <div className="space-y-5">
                            <div className="flex items-center justify-between gap-4">
                                <div className="sapce-y-1.5">
                                    ...
                                    https://www.airbnb.com.br/rooms/10470001123432423423432424
                                    </a>
                                </div>
